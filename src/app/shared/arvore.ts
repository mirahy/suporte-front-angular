export class Arvore {
    ...
    find (id:number|null):Arvore|any {
    ...
    insert (filho:Arvore, paiId?:number|any) {
    ...
    delete (id?:number|any, upper:boolean = false) {
    ...
    isAncestral (id:any, descendenteId:any) {
        var nodo:Arvore = this.find(id);
