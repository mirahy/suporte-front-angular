...
export class Macro {
	...
	constructor(id:(number|any), nome?:string, arquivo?:Arquivo|unknown, periodo_letivo?:PeriodoLetivo|number|unknown, link_servidor_moodle?:string|unknown, buscadores?: Array<Buscador>|any) {
        if (typeof id == "number") {
            this.id = id;
            this.nome = nome;
