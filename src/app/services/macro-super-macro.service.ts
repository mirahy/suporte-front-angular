...
export class MacroSuperMacroService {
    ...
    msmIndex: ArrayIndexador<MacroSuperMacro> | undefined ;
    msmIndexOrder: ArrayIndexador<MacroSuperMacro> | undefined;

	CAMPOS = [];
	OPERADORES = [];

    constructor(private http: HttpClient, private periodoLetivosService: PeriodoLetivosService, private macroService: MacroService, private superMacroService: SuperMacroService) {
        this.getCampos();
        this.getOperadores();
    }
